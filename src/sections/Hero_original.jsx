    ...
    <section id="home" className="relative overflow-hidden pt-24 pb-20 bg-linear-to-t from-[#020817] via-[#0a192f] to-[#0f172a]">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 md:grid-cols-2">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-sky-500/30 bg-white/5 p-1 shadow-[0_20px_60px_rgba(10,25,47,0.4)]"
        >
          <motion.div
            animate={{
              rotateY: [-1, 1, -1],
            ...
            className="grid grid-cols-1 gap-6 p-6 items-center justify-items-center h-full w-full"
          >
            <img
              src="/dist/assets/proyek/hero.png"
              alt="Developer profile"
              className="h-80 w-full rounded-2xl object-cover transition-transform duration-500 hover:scale-105"
              loading="lazy"
            />
